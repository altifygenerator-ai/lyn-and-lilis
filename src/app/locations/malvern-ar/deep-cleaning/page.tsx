...
const canonicalPath = "/locations/malvern-ar/deep-cleaning";
const pageMeta = getLocalServiceMeta("malvern-ar", "deep-cleaning");
const localFaq = getLocalServiceFaq("malvern-ar", "deep-cleaning");
...
export default function MalvernDeepCleaningPage() {
