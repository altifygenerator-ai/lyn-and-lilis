...
const location = getLocation("malvern-ar");
const service = getService("professional-building-cleaning");
const canonicalPath = "/locations/malvern-ar/professional-building-cleaning";
const pageMeta = getLocalServiceMeta("malvern-ar", "professional-building-cleaning");
const localFaq = getLocalServiceFaq("malvern-ar", "professional-building-cleaning");
...
export default function MalvernProfessionalBuildingCleaningPage() {
