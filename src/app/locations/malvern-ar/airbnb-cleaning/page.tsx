...
const canonicalPath = "/locations/malvern-ar/airbnb-cleaning";
const pageMeta = getLocalServiceMeta("malvern-ar", "airbnb-cleaning");
const localFaq = getLocalServiceFaq("malvern-ar", "airbnb-cleaning");
...
export default function MalvernAirbnbCleaningPage() {
