...
const canonicalPath = "/locations/malvern-ar/move-in-move-out-cleaning";
const pageMeta = getLocalServiceMeta("malvern-ar", "move-in-move-out-cleaning");
const localFaq = getLocalServiceFaq("malvern-ar", "move-in-move-out-cleaning");
...
export default function MalvernMoveInMoveOutCleaningPage() {
