...
const canonicalPath = "/locations/malvern-ar/standard-cleaning";
const pageMeta = getLocalServiceMeta("malvern-ar", "standard-cleaning");
const localFaq = getLocalServiceFaq("malvern-ar", "standard-cleaning");
...
export default function MalvernStandardCleaningPage() {
