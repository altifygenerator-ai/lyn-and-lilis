...
const canonicalPath = "/locations/glenwood-ar/move-in-move-out-cleaning";
const pageMeta = getLocalServiceMeta("glenwood-ar", "move-in-move-out-cleaning");
const localFaq = getLocalServiceFaq("glenwood-ar", "move-in-move-out-cleaning");
...
export default function GlenwoodMoveInMoveOutCleaningPage() {
