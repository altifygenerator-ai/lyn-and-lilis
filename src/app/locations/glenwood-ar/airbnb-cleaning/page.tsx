...
const canonicalPath = "/locations/glenwood-ar/airbnb-cleaning";
const pageMeta = getLocalServiceMeta("glenwood-ar", "airbnb-cleaning");
const localFaq = getLocalServiceFaq("glenwood-ar", "airbnb-cleaning");
...
export default function GlenwoodAirbnbCleaningPage() {
