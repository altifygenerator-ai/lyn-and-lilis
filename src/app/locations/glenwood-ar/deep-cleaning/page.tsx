...
const canonicalPath = "/locations/glenwood-ar/deep-cleaning";
const pageMeta = getLocalServiceMeta("glenwood-ar", "deep-cleaning");
const localFaq = getLocalServiceFaq("glenwood-ar", "deep-cleaning");
...
export default function GlenwoodDeepCleaningPage() {
