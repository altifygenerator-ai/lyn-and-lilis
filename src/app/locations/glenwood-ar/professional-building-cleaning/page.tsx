...
const location = getLocation("glenwood-ar");
const service = getService("professional-building-cleaning");
const canonicalPath = "/locations/glenwood-ar/professional-building-cleaning";
const pageMeta = getLocalServiceMeta("glenwood-ar", "professional-building-cleaning");
const localFaq = getLocalServiceFaq("glenwood-ar", "professional-building-cleaning");
...
export default function GlenwoodProfessionalBuildingCleaningPage() {
