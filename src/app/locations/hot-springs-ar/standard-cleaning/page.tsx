...
const canonicalPath = "/locations/hot-springs-ar/standard-cleaning";
const pageMeta = getLocalServiceMeta("hot-springs-ar", "standard-cleaning");
const localFaq = getLocalServiceFaq("hot-springs-ar", "standard-cleaning");
...
export default function HotSpringsStandardCleaningPage() {
