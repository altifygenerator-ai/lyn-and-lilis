...
const canonicalPath = "/locations/hot-springs-ar/senior-home-help";
const pageMeta = getLocalServiceMeta("hot-springs-ar", "senior-home-help");
const localFaq = getLocalServiceFaq("hot-springs-ar", "senior-home-help");
...
export default function HotSpringsSeniorHomeHelpPage() {
