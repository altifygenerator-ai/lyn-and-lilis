...
const canonicalPath = "/locations/hot-springs-ar/holiday-special-occasion-cleaning";
const pageMeta = getLocalServiceMeta("hot-springs-ar", "holiday-special-occasion-cleaning");
const localFaq = getLocalServiceFaq("hot-springs-ar", "holiday-special-occasion-cleaning");
...
export default function HotSpringsHolidaySpecialOccasionCleaningPage() {
