...
const canonicalPath = "/locations/hot-springs-ar/professional-building-cleaning";
const pageMeta = getLocalServiceMeta("hot-springs-ar", "professional-building-cleaning");
const localFaq = getLocalServiceFaq("hot-springs-ar", "professional-building-cleaning");
...
export default function HotSpringsProfessionalBuildingCleaningPage() {
