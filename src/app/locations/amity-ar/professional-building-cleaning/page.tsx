...
const location = getLocation("amity-ar");
const service = getService("professional-building-cleaning");
const canonicalPath = "/locations/amity-ar/professional-building-cleaning";
const pageMeta = getLocalServiceMeta("amity-ar", "professional-building-cleaning");
const localFaq = getLocalServiceFaq("amity-ar", "professional-building-cleaning");
...
export default function AmityProfessionalBuildingCleaningPage() {
