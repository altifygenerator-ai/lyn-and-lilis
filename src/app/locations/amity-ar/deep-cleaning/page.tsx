...
const canonicalPath = "/locations/amity-ar/deep-cleaning";
const pageMeta = getLocalServiceMeta("amity-ar", "deep-cleaning");
const localFaq = getLocalServiceFaq("amity-ar", "deep-cleaning");
...
export default function AmityDeepCleaningPage() {
