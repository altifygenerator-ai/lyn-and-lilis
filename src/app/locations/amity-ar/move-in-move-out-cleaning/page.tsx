...
const canonicalPath = "/locations/amity-ar/move-in-move-out-cleaning";
const pageMeta = getLocalServiceMeta("amity-ar", "move-in-move-out-cleaning");
const localFaq = getLocalServiceFaq("amity-ar", "move-in-move-out-cleaning");
...
export default function AmityMoveInMoveOutCleaningPage() {
