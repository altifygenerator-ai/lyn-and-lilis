...
const canonicalPath = "/locations/amity-ar/standard-cleaning";
const pageMeta = getLocalServiceMeta("amity-ar", "standard-cleaning");
const localFaq = getLocalServiceFaq("amity-ar", "standard-cleaning");
...
export default function AmityStandardCleaningPage() {
