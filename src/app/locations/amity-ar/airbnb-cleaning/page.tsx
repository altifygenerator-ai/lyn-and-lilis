...
const canonicalPath = "/locations/amity-ar/airbnb-cleaning";
const pageMeta = getLocalServiceMeta("amity-ar", "airbnb-cleaning");
const localFaq = getLocalServiceFaq("amity-ar", "airbnb-cleaning");
...
export default function AmityAirbnbCleaningPage() {
