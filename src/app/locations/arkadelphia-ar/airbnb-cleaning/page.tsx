...
const canonicalPath = "/locations/arkadelphia-ar/airbnb-cleaning";
const pageMeta = getLocalServiceMeta("arkadelphia-ar", "airbnb-cleaning");
const localFaq = getLocalServiceFaq("arkadelphia-ar", "airbnb-cleaning");
...
export default function ArkadelphiaAirbnbCleaningPage() {
