...
const canonicalPath = "/locations/arkadelphia-ar/deep-cleaning";
const pageMeta = getLocalServiceMeta("arkadelphia-ar", "deep-cleaning");
const localFaq = getLocalServiceFaq("arkadelphia-ar", "deep-cleaning");
...
export default function ArkadelphiaDeepCleaningPage() {
