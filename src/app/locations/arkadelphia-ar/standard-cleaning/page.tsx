...
const canonicalPath = "/locations/arkadelphia-ar/standard-cleaning";
const pageMeta = getLocalServiceMeta("arkadelphia-ar", "standard-cleaning");
const localFaq = getLocalServiceFaq("arkadelphia-ar", "standard-cleaning");
...
export default function ArkadelphiaStandardCleaningPage() {
