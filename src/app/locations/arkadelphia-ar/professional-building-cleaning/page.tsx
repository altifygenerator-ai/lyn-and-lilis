...
const canonicalPath = "/locations/arkadelphia-ar/professional-building-cleaning";
const pageMeta = getLocalServiceMeta("arkadelphia-ar", "professional-building-cleaning");
const localFaq = getLocalServiceFaq("arkadelphia-ar", "professional-building-cleaning");
...
export default function ArkadelphiaProfessionalBuildingCleaningPage() {
